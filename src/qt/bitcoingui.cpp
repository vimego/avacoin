...
void BitcoinGUI::createActions()
{
    ...
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &AvaCoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the AvaCoin window"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide AvaCoin"
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        ...
        labelMiningIcon->setToolTip(tr("Mining AvaCoin at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining AvaCoin"));
    }
}
